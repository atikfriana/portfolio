...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const formSubmitUrl = 'https://formsubmit.co/atikafit.arifiana@gmail.com';
  ...
  return (
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] " >
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          Looking forward to hearing from you, don’t hesitate to connect.
        </p>
      </div>
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                 Interested in working together? I'm open to new ideas, collaborations, and opportunities. Drop me a message, let’s talk!
                </p>
              </div>
